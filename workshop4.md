...
Из скрина выше видим, что значение Total Error 1, следовательно, одной эпохи недостаточно.

Зададим 5 эпох и получим такой результат: ![Uploading image.png…]()
...
Условия работы перцептрона: 

Зададим одну обучающую эпоху и получим такой результат: 
