...
Зададим одну обучающую эпоху и получим такой результат: ![image](https://github.com/Eiasav/da-in-gamedev/assets/130223999/bb682586-57dc-4833-925c-ff09b7383cde)
Из скрина выше видим, что значение Total Error 0, следовательно, модель обучилась за одну эпоху.
...
Зададим одну обучающую эпоху и получим такой результат: ![image](https://github.com/Eiasav/da-in-gamedev/assets/130223999/0ed9a4a6-8b55-4d65-8318-8915a039fe53)
Как и в первом пункте одной обучающей эпохи оказалось достаточно.
